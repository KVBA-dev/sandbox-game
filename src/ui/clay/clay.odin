...
OpenElementWithId :: _OpenElementWithId
...
PaddingAll :: proc "contextless" (allPadding: u16) -> Padding {
	return { left = allPadding, right = allPadding, top = allPadding, bottom = allPadding }
}

BorderOutside :: proc "contextless" (width: u16) -> BorderWidth {
	return {width, width, width, width, 0}
}

BorderAll :: proc "contextless" (width: u16) -> BorderWidth {
	return {width, width, width, width, width}
}

CornerRadiusAll :: proc "contextless" (radius: f32) -> CornerRadius {
...
SizingGrow :: proc "contextless" (sizeMinMax: SizingConstraintsMinMax = {}) -> SizingAxis {
	return SizingAxis{type = SizingType.Grow, constraints = {sizeMinMax = sizeMinMax}}
}

SizingFixed :: proc "contextless" (size: c.float) -> SizingAxis {
	return SizingAxis{type = SizingType.Fixed, constraints = {sizeMinMax = {size, size}}}
}

SizingPercent :: proc "contextless" (sizePercent: c.float) -> SizingAxis {
